...
public class LoggedInActivity {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        Thread.sleep(1000);
        boolean isLogoutDisplayed = driver.findElement(By.xpath("//button[text() = 'Log out']"))
                .isDisplayed();
        ...
        boolean isCartQuantityDisplayed = driver.findElement(By.xpath("//span[@class='top-nav__cart-quantity']")).isDisplayed();
